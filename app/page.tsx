...
export default async function Home({ searchParams }: PageProps) {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center py-2 font-sans text-gray-200 relative gap-4 text-xs sm:text-base md:text-lg lg:text-2xl 2xl:text-4xl">
      <h1
